...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        url="https://github.com/BobCoderS9/XrayR-release/releases/download/${last_version}/XrayR-linux-${arch}.zip"
    ...
    file="https://github.com/BobCoderS9/XrayR-release/raw/master/XrayR.service"
    ...
    if [[ ! -f /etc/XrayR/config.yml ]]; then
        ...
        echo -e ""
        echo -e "全新安装，请先参看教程：https://github.com/XL320/Xrayr_releasefork，配置必要的内容"
    else
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/XL320/Xrayr_releasefork/master/install.sh
